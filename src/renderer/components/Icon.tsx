...
const TwoThirdsCircle = createSvgIcon(
  <svg viewBox="0 0 248 248" xmlns="http://www.w3.org/2000/svg">
    <title>Two Thirds Circle</title>
    <path
...
const ThreeThirdsCircle = createSvgIcon(
  <svg viewBox="0 0 248 248" xmlns="http://www.w3.org/2000/svg">
    <title>Three Thirds Circle</title>
    <path
...
export const CanceledIcon = () => (
  <ThreeThirdsCircle sx={{ fill: (theme) => theme.palette.error.main }} />
);

export const BlockedIcon = () => (
  <OneThirdsCircle sx={{ fill: (theme) => theme.palette.warning.main }} />
);

export const CompletedIcon = () => (
  <ThreeThirdsCircle sx={{ fill: (theme) => theme.palette.secondary.main }} />
);

export const InProgressIcon = () => (
  <TwoThirdsCircle sx={{ fill: (theme) => theme.palette.secondary.main }} />
);

export const NewIcon = () => (
  <OneThirdsCircle sx={{ fill: (theme) => theme.palette.secondary.main }} />
);
